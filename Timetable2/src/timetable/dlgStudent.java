...
public class dlgStudent extends javax.swing.JDialog {
        ...
        try {
            ...
            if(clsCon.getRs().first()){  
                do{
                    ...
                    String st[]={id,name,gender,dob,address,phone,Class,Semester};
                    modeTbl.addRow(st);
                }while(clsCon.getRs().next());
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jtblStu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Student Name", "Gender", "DOB", "Address", "Phone", "Class Name", "Semester"
            }
        ));
    ...
    public void CheckCLass(){
        try {
            clsCon.setRs(clsCon.getStmt().executeQuery("select * from qStuAmount where ClassID = '"+lblClassID.getText()+"' and SemesterID = '"+lblSemesterID.getText()+"'"));
            clsCon.getRs().first();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String  sql="insert into tblStudent(StuID,StuName,Gender,DOB,Address,Phone,ClassID,SemesterID,Auto) values('"+txtID.getText()+"','" + txtName.getText()+ "','"+cboGender.getSelectedItem()+"','"+txtDOB.getText()+"','"+txtAddress.getText()+"','"+txtPhone.getText()+"','"+lblClassID.getText()+"','"+lblSemesterID.getText()+"','"+i+"')";
        try {
           ...
           DefaultTableModel modeTbl = (DefaultTableModel)jtblStu.getModel();
              ...
              clsCon.getRs().first();
                    ...
                    String Semester=clsCon.getRs().getString("Semester");
                    String st[]={id,name,gender,dob,address,phone,ClassID,Semester};
                    modeTbl.addRow(st);
                    clear();
                      getIdAuto();
    ...
    private void jtblStuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblStuMouseClicked
      ...
      int index = jtblStu.getSelectedRow();
       ...
       String ClassName=""+jtblStu.getValueAt(index,6);
       String Semester=""+jtblStu.getValueAt(index,7);
        txtID.setText(ID);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String  sql="update tblStudent set StuName='"+txtName.getText()+"', Gender='"+cboGender.getSelectedItem()+"', DOB='"+txtDOB.getText()+"',Address='"+txtAddress.getText()+"',Phone='"+txtPhone.getText()+"',ClassID='"+lblClassID.getText()+"',SemesterID='"+lblSemesterID.getText()+"' where StuID='"+txtID.getText()+"'";
        try {
            clsCon.getStmt().executeUpdate(sql);
            ...
            jtblStu.setValueAt(txtPhone.getText(), index, 5);
             jtblStu.setValueAt(cboClassID.getSelectedItem(), index, 6);
            jtblStu.setValueAt(cboSemesterid.getSelectedItem(), index, 7);
                clear();
                getIdAuto();
                btnUpdate.setEnabled(false);
                btnDelete.setEnabled(false);
