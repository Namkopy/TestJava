...
public class dlgClassRoom extends javax.swing.JDialog {
    ...
    void getCboRoom(){        
        ...
        try {    
                ...
                if(clsCon.getRs().first())
                    do{
                        cboRoom.addItem(clsCon.getRs().getString("RoomNumber"));
                    }while(clsCon.getRs().next());
        }
        catch(Exception ex){
            ex.printStackTrace();
    ...
    void ShowRoomNumber(){
        cboRoom.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent ie) {
               ...
               try {
                    clsCon.setRs(clsCon.getStmt().executeQuery("Select RoomID from tblRoom where RoomNumber='"+c+"'"));
                    clsCon.getRs().first();
                    lblRoomID.setText(clsCon.getRs().getString("RoomID"));
                } catch (SQLException ex) {
                    ex.printStackTrace();
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblShiftID, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(lblSessionID, javax.swing.GroupLayout.Alignment.TRAILING))))
