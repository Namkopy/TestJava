        ...
        try {
            ...
            if(clsCon.getRs().first()){  
                do{
                    ...
                    String st[]={roomid,roomName,building};
  ...
  int i=0;
   void getIdAuto(){
    ...
    private void initComponents() {
        ...
        cboBuilding.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A", "B", "C", "D" }));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
       int index = jtblRoom.getSelectedRow();
        if(index==-1)
        return;
        String  sql="update tblRoom set RoomNumber='"+txtRoomNumber.getText()+"', Building='"+cboBuilding.getSelectedItem()+"' where RoomID='"+txtRoomID.getText()+"'";
        try {
            ...
            jtblRoom.setValueAt(cboBuilding.getSelectedItem(), index, 2);
            clear();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            do{
                try {
                    ...
                    Logger.getLogger(dlgRoom.class.getName()).log(Level.SEVERE, null, ex);
                }
            }while (clsCon.getRs().next());
        } catch (SQLException ex) {
            Logger.getLogger(dlgRoom.class.getName()).log(Level.SEVERE, null, ex);
        ...
        String sql = "insert into tblRoom(RoomID,RoomNumber,Building,Auto) values('"+txtRoomID.getText()+"','"+txtRoomNumber.getText()+"','"+cboBuilding.getSelectedItem()+"','"+i+"')";
        try {
            clsCon.getStmt().executeUpdate(sql);
    ...
    private void jtblRoomMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblRoomMouseClicked
        ...
        String building = ""+jtblRoom.getValueAt(index, 2); //building
