  ...
  void getCboCourse(){        
        ...
        try {
            ...
            if(clsCon.getRs().first()){  
                do{
                    ...
                    String st[]={id,name,gender,phone,Course};
    ...
    private void initComponents() {
        ...
        jtblTescher.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Teacher ID", "Teacher Name", "Gender", "Phone", "Course"
            }
        ));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String  sql="update tblTeacher set Name='"+txtName.getText()+"', Gender='"+cboGender.getSelectedItem()+"',Phone='"+txtPhone.getText()+"',CourseID='"+lblCourseID.getText()+"' where TeacherID='"+txtID.getText()+"'";
        try {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String  sql="insert into tblTeacher(TeacherID,Name,Gender,Phone,CourseID,Auto) values('"+txtID.getText()+"','" + txtName.getText()+ "','"+cboGender.getSelectedItem()+"','"+txtPhone.getText()+"','"+lblCourseID.getText()+"','"+i+"')";
        try {
            clsCon.getStmt().executeUpdate(sql);
